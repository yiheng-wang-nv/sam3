...
# Paths
SAM3_OUTPUT_DIR="/localhome/local-vennw/code/task4-2_0226022703050309_merged/sam3_output"
DATASET_ROOT="/localhome/local-vennw/code/task4-2_0226022703050309_merged"
