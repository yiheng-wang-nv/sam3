...
# Configuration
BASE_DIR="/localhome/local-vennw/code/task4-1_02260227_merged/videos/chunk-000"
SAM3_OUTPUT="/localhome/local-vennw/code/task4-1_02260227_merged/sam3_output"
...
OUTPUT_DIR="/localhome/local-vennw/code/task4-1_02260227_merged/comparison_videos"

NUM_SAMPLES=10
N_PARALLEL=10
SEED=42
MIN_EPISODE=0  # Only select episodes with index > this value
MAX_EPISODE=300  # Only select episodes with index < this value
