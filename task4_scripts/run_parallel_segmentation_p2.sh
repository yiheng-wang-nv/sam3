...
BASE_OUTPUT_DIR="/localhome/local-vennw/code/task4-2_0226022703050309_merged/sam3_output"
...
echo "🚀 Starting Parallel Segmentation Job (task4-2_20260226_trimmed)"
echo "--------------------------------------------------------------------"
