...
SAM3_OUTPUT="/localhome/local-vennw/code/task4-2_02020205_merged/sam3_output"
...
OUTPUT_DIR="/localhome/local-vennw/code/task4-2_02020205_merged/comparison_videos"
