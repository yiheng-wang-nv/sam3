...
SAM3_OUTPUT="/localhome/local-vennw/code/task5-1_02030204021002130214_merged/sam3_output"
...
OUTPUT_DIR="/localhome/local-vennw/code/task5-1_02030204021002130214_merged/comparison_videos"

NUM_SAMPLES=10
N_PARALLEL=10
SEED=42
MIN_EPISODE=1  # Only select episodes with index > this value
MAX_EPISODE=1000  # Only select episodes with index < this value
