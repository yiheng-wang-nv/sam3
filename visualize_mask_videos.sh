...
python /localhome/local-vennw/code/sam3/visualize_masks.py \
  --dataset_root /localhome/local-vennw/code/task4-2_20260202_trimmed \
  --mask_root /localhome/local-vennw/code/task4-2_20260202_trimmed/sam3_output \
  --output_dir /localhome/local-vennw/code/task4-2_20260202_trimmed/viz_videos \
  --cameras observation.images.head_left_camera_color_optical_frame \
  --save_video \
  --videos_per_camera 1 \
  --fps 30 \
  --seed 0
